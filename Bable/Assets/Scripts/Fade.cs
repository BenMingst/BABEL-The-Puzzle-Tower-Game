...
/// <summary>
/// Distance-based sprite alpha: invisible when the player is close, fully visible when farther.
/// </summary>
public class Fade : MonoBehaviour
{
    [Header("References")]
    [SerializeField] private Transform player;
    [Tooltip("Optional. If empty, uses SpriteRenderer on this object or children.")]
    [SerializeField] private SpriteRenderer spriteRenderer;

    [Header("Distance fade")]
    [Tooltip("At this distance or closer, alpha is 0.")]
    [SerializeField, Range(0.05f, 15f)]
    private float fullyInvisibleAtDistance = 1f;

    [Tooltip("At this distance or farther, alpha is 1.")]
